# Instruções para Agentes de IA — Meus Remédios

> App Android **100% offline** que confirma visualmente, pela câmera, qual remédio
> **pré-cadastrado** é o comprimido em mãos. Público idoso. Veja [`AGENTS.md`](../AGENTS.md),
> [`CLAUDE.md`](../CLAUDE.md) e [`docs/README.md`](../docs/README.md).
...
- **Atualizar o [`CHANGELOG.md`](../CHANGELOG.md)** (seção "Não lançado") em mudanças
  relevantes.
- Manter [`AGENTS.md`](../AGENTS.md) sincronizado quando convenções/arquitetura mudarem.
