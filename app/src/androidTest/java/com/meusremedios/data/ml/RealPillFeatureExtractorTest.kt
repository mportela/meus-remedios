...
class RealPillFeatureExtractorTest {
    ...
    private fun copyAssetToTemp(testContext: android.content.Context, appContext: android.content.Context, assetName: String): File {
    ...
    private fun buildConst(name: String, f: PhotoFeatures): String {
        val emb = f.embedding
        val embStr = if (emb != null) {
