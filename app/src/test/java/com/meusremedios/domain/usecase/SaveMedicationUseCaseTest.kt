...
class SaveMedicationUseCaseTest {
    ...
    @Test
    fun `rejects end date before start date`() = runTest {
    ...
    @Test
    fun `creates medication with trimmed name and schedules`() = runTest {
        val result = useCase(
    ...
    @Test
    fun `updates medication and reconciles schedules`() = runTest {
