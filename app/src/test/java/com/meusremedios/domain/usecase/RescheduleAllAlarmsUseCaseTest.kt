...
class RescheduleAllAlarmsUseCaseTest {
    ...
    @Test
    fun `cancels all existing alarms before rescheduling`() =
        runTest {
    ...
    @Test
    fun `schedules midnight alarm after rescheduling`() =
        runTest {
            useCase()
    ...
    @Test
    fun `reschedules active doses after cancelling old ones`() =
        runTest {
