...
class GetPendingDosesTodayForMedicationUseCaseTest {
    ...
    private val useCase =
        GetPendingDosesTodayForMedicationUseCase(
    ...
    @Test
    fun `medicamento com 1 dose hoje sem log - retorna 1 dose`() =
        runTest {
    ...
    @Test
    fun `medicamento com dose TAKEN hoje - retorna 0 doses`() =
        runTest {
            val id = medications.add(Medication(name = "Losartana"))
    ...
    @Test
    fun `medicamento sem horarios hoje - retorna 0 doses`() =
        runTest {
            val id = medications.add(Medication(name = "Losartana"))
