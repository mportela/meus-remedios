...
class ScheduleAlarmsForTodayUseCaseTest {
    ...
    fun setUp() {
        ...
        useCase = ScheduleAlarmsForTodayUseCase(
    ...
    @Test
    fun `schedules alarm for active medication with reminders enabled`() = runTest {
    ...
    @Test
    fun `skips scheduling when remindersGlobal is false`() = runTest {
    ...
    @Test
    fun `skips scheduling when medication remindersEnabled is false`() = runTest {
    ...
    @Test
    fun `skips scheduling when time has already passed`() = runTest {
        val id = medicationRepository.add(Medication(name = "Losartana", remindersEnabled = true))
    ...
    @Test
    fun `respects reminderLeadMinutes offset`() = runTest {
