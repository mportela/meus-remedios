...
class RecognizeMedicationUseCaseTest {
    ...
    private class MapFeatureExtractor(
        ...
        override suspend fun extract(imagePath: String): PhotoFeatures = byPath.getValue(imagePath)
    }
    ...
    private suspend fun seedMedicationWithColor(
        name: String,
        l: Float,
        aspect: Float = 1f,
    ): Long {
    ...
    private fun useCase(extractor: FeatureExtractor) = RecognizeMedicationUseCase(photos, medications, extractor)

    @Test
    fun `sem fotos cadastradas retorna NoPhotosRegistered`() =
        runTest {
    ...
    @Test
    fun `identifica medicamento com cor mais proxima`() =
        runTest {
    ...
    @Test
    fun `cores proximas geram resultado ambiguo`() =
        runTest {
    ...
    @Test
    fun `segunda foto agrega pelo melhor score por medicamento`() =
        runTest {
