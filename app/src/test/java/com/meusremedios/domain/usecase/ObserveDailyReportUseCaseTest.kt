...
class ObserveDailyReportUseCaseTest {
    ...
    @Test
    fun `deriva status atrasado e pendente conforme horario`() =
        runTest {
    ...
    @Test
    fun `dose com registro tomado aparece como tomada`() =
        runTest {
    ...
    @Test
    fun `agrupa doses por periodo do dia`() =
        runTest {
    ...
    @Test
    fun `exclui horario que nao cai no dia da semana`() =
        runTest {
    ...
    @Test
    fun `exclui medicamento fora do intervalo de uso`() =
        runTest {
            val id =
                medications.add(
