...
class CleanupOldIntakesUseCaseTest {
    ...
    private fun makeLog(date: LocalDate) =
        IntakeLog(
            medicationId = 1L,
            date = date,
    ...
    @Test
    fun `remove logs anteriores ao corte`() =
        runTest {
    ...
    @Test
    fun `nao remove logs dentro do periodo`() =
        runTest {
    ...
    @Test
    fun `respeita configuracao de retencao de 30 dias`() =
        runTest {
