...
class TfliteFeatureExtractorTest {
    ...
    @Test
    fun `embedding ausente e imprint nulo preserva features de base`() =
        runTest {
    ...
    @Test
    fun `embedding calculado e imprint nulo sao anexados`() =
        runTest {
            coEvery { base.extract(any()) } returns baseFeatures
    ...
    @Test
    fun `imprint lido pelo reader e anexado ao resultado`() =
        runTest {
            coEvery { base.extract(any()) } returns baseFeatures
            every { embedder.embed(any()) } returns null
    ...
    @Test
    fun `falha do imprint reader retorna null sem propagar excecao`() =
        runTest {
            coEvery { base.extract(any()) } returns baseFeatures
            every { embedder.embed(any()) } returns null
            coEvery { imprintReader.read(any()) } returns null
