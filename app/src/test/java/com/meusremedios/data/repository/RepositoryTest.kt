...
class RepositoryTest {
    ...
    @Test
    fun add_thenObserve_mapsToDomain() = runTest {
        val id = medicationRepository.add(
            Medication(
                name = "Dipirona",
                dosage = "500 mg",
    ...
    @Test
    fun settings_returnsDefaults_whenEmpty() = runTest {
    ...
    @Test
    fun settings_persistsUpdate() = runTest {
