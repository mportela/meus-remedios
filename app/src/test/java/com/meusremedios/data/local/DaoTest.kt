...
class DaoTest {
    ...
    private fun medication(name: String) = MedicationEntity(
        name = name,
        dosage = null,
        notes = null,
    ...
    @Test
    fun insertAndGetMedication_preservesData() = runTest {
    ...
    @Test
    fun observeAll_isOrderedByName() = runTest {
    ...
    @Test
    fun observeAll_emitsOnInsert() = runTest {
    ...
    @Test
    fun deletingMedication_cascadesPhotos() = runTest {
    ...
    @Test
    fun photoEmbedding_roundTripsThroughBlob() = runTest {
    ...
    @Test
    fun intakeLog_filteredByDate() = runTest {
    ...
    @Test
    fun intakeLog_deleteOlderThan_removesPastLogs() = runTest {
    ...
    @Test
    fun appSettings_upsertReplacesSingleton() = runTest {
    ...
    private fun intakeLog(medicationId: Long, date: String) = IntakeLogEntity(
    ...
    private fun settings(retention: Int) = AppSettingsEntity(
