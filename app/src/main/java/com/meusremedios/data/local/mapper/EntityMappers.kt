...
fun MedicationPhotoEntity.toDomain(): MedicationPhoto = MedicationPhoto(
    id = id,
...
fun MedicationPhoto.toEntity(): MedicationPhotoEntity = MedicationPhotoEntity(
    id = id,
    medicationId = medicationId,
    filePath = filePath,
    side = side,
...
fun ScheduleTime.toEntity(): ScheduleTimeEntity = ScheduleTimeEntity(
    id = id,
    medicationId = medicationId,
