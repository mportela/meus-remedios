...
class IntakeLogRepositoryImpl
    ...
    constructor(
        ...
        override suspend fun add(log: IntakeLog): Long = intakeLogDao.insert(log.toEntity())

        override suspend fun update(log: IntakeLog) = intakeLogDao.update(log.toEntity())

        override suspend fun delete(log: IntakeLog) = intakeLogDao.delete(log.toEntity())

        override suspend fun deleteOlderThan(thresholdDate: LocalDate): Int = intakeLogDao.deleteOlderThan(thresholdDate.toString())
